...
public class PartidosParser {
     ...
     */
    public static List<Partido> crearPartidos(String rutaCarpeta, ObjectMapper objectMapper, List<Equipo> equipos) throws IOException {
        ...
        return archivos != null
                ...
                : List.of(); // Devolver una lista vacía si no hay archivos
    }
}
